      ...
      await client.query(
        `INSERT INTO medicines
          (name, generic_name, brand, strength, pack_size, manufacturer, description,
           ...
           discount, gst_rate, stock, min_order_qty, prescription_required,
        ...
        [
          ...
          m.stock, m.minOrderQty, m.prescriptionRequired,
